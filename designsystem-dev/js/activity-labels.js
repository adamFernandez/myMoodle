...
$("#region-main h2:first-of-type:contains('-indent'), .breadcrumb li a span:contains('-indent'), .row-fluid.rtl-compatible .span4 a:contains('activity-label')").text(function(i, currentText) {
