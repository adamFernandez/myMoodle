...
$("noSubChaps .block_book_toc .content ul > li:only-child, #page-mod-book-print .book_toc_numbered > ul > li:only-child").parents("#page-content").addClass("single-chapter-book");
