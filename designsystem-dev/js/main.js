...
*/
$("div:contains('activity-label'), span:contains('activity-label'), h1:first-of-type:contains('activity-label'),
h2:contains('activity-label'), p:contains('activity-label'), a:contains('activity-label'),
td:contains('activity-label')").text(function(i, currentText) {
