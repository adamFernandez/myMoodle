...
$("#page-question-edit select optgroup, #page-question-category select optgroup").attr("label", function(i, currentText) {
  return currentText.replace(/activity-label-[a-z]{3}-[a-z]{3}-[a-z]{3} /g, '');
});
